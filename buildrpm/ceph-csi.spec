...
%build
make cephcsi LDFLAGS="-X main.version=3.16.3"
...
%changelog
* Tue Sep 01 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.16.3-1
