...
%build
make cephcsi LDFLAGS="-X main.version=3.16.2"
...
%changelog
* Tue Mar 24 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.16.2-1
