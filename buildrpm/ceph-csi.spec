...
%build
make cephcsi LDFLAGS="-X main.version=3.17.1"
...
%changelog
* Mon Aug 24 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.17.1-1
