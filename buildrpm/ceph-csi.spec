...
%build
make cephcsi LDFLAGS="-X main.version=3.17.0"
...
%changelog
* Tue May 26 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.17.0-1
